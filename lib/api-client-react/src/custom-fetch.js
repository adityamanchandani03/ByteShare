...
__name(setBaseUrl, "setBaseUrl");
function setAuthTokenGetter(getter) {
  _authTokenGetter = getter;
}
__name(setAuthTokenGetter, "setAuthTokenGetter");
...
__name(resolveMethod, "resolveMethod");
...
__name(applyBaseUrl, "applyBaseUrl");
...
__name(isJsonMediaType, "isJsonMediaType");
...
__name(isTextMediaType, "isTextMediaType");
...
class ResponseParseError extends Error {
  static {
    __name(this, "ResponseParseError");
  }
...
__name(inferResponseType, "inferResponseType");
...
__name(parseSuccessBody, "parseSuccessBody");
...
__name(customFetch, "customFetch");
export {
  ApiError,
  ResponseParseError,
  customFetch,
